...
class ScheduleRepository implements ScheduleContract
{
    ...
    public function getPayloadById(int $id)
    {
        try {
            ...
            $find = $this->scheduleModel->whereId($id)->first();
    ...
    public function upsertPayload($id, array $payload)
    {
        try {
            ...
            if ($id) {
                ...
                $result = [
                    'data' => $this->scheduleModel->whereId($id)->update($payload),
    ...
    public function deletePayload(int $id)
    {
        try {
            ...
            $data = $this->scheduleModel->whereId($id)->delete();
